...
try {
  console.log(JSON.stringify(import_github2.default, null, 2));
  const options = {
    repo: import_github2.default.context.repo.repo,
    username: import_github2.default.context.actor || void 0,
    webhook: import_core.default.getInput("discord-webhook") || void 0,
    filename: import_core.default.getInput("template") || void 0,
    token: import_core.default.getInput("personal-github-token") || void 0
  };
  console.log(options);
} catch (error) {
